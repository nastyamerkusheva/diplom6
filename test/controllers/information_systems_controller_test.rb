...
class InformationSystemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information_system" do
    assert_difference('InformationSystem.count') do
      post information_systems_url, params: { information_system: { name: @information_system.name, number_of_characteristics: @information_system.number_of_characteristics, timezone: @information_system.timezone } }
    end
  ...
  test "should update information_system" do
    patch information_system_url(@information_system), params: { information_system: { name: @information_system.name, number_of_characteristics: @information_system.number_of_characteristics, timezone: @information_system.timezone } }
