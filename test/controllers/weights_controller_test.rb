...
class WeightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weight" do
    assert_difference('Weight.count') do
      post weights_url, params: { weight: { default: @weight.default, name: @weight.name, part_of_characteristic_id: @weight.part_of_characteristic_id, weight_val: @weight.weight_val } }
    end
  ...
  test "should update weight" do
    patch weight_url(@weight), params: { weight: { default: @weight.default, name: @weight.name, part_of_characteristic_id: @weight.part_of_characteristic_id, weight_val: @weight.weight_val } }
